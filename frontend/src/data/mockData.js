...
export const mockMetrics = [
  {
    ...
    trend: "up",
    aiInsight:
      "Document volume increased 23% this month. AI suggests focusing on compliance docs.",
    icon: "FileText",
  },
  {
    id: 2,
    ...
    trend: "up",
    aiInsight:
      "Audit quality improved. AI detected 15% fewer compliance issues.",
    icon: "Brain",
  },
  {
    id: 3,
    ...
    trend: "down",
    aiInsight:
      "Risk profile improved. AI recommends quarterly review adjustments.",
    icon: "Shield",
  },
  {
    id: 4,
    ...
    trend: "down",
    aiInsight:
      "AI processing speed optimized. Average analysis time reduced significantly.",
    icon: "Clock",
  },
];
...
export const mockDocuments = [
  {
    ...
    aiScore: 95,
    aiSummary:
      "Comprehensive financial audit with minor compliance notes. AI detected 3 potential areas for improvement.",
  ...
  },
  {
    ...
    aiScore: 88,
    aiSummary:
      "Risk matrix shows moderate exposure. AI suggests focus on operational risks.",
...
export const mockAIConversation = [
  {
    ...
    type: "ai",
    content:
      "Hello! I'm your AI audit assistant. I've analyzed your latest documents and found some interesting patterns. Would you like me to summarize the key findings?",
    timestamp: "10:30 AM",
    confidence: 95,
    liked: null,
  },
...
export const mockNavigationItems = [
  ...
  },
  {
    ...
    active: false,
    aiPriority: "high",
    aiNote: "AI-powered insights ready",
  },
  {
    id: 4,
    title: "Predictive",
